			...
			<form method="post" id="deal-submission-form" enctype="multipart/form-data">
				...
				<div id="submission-form-tabs">
  					<ul>
    					...
    					<li class="tab-log-line"><a href="#log-line"><?php _e('Description', 'Reality' ); ?></a></li>
 					...
 					<div class="clear"></div>
  					<div id="maker-card">
						...
						<div class="input-container">
							<input type="text" name="maker_card_id" id="maker_card_id" placeholder="ex. 233"<?php if ( $maker_card_id ) echo ' value="'.$maker_card_id.'" disabled'; ?>>
						</div> 
					</div>
				  	<div id="deal-title">
  					...
  					<div id="log-line">
    					<label class="required"><?php _e('Description', 'Reality'); ?></label>
    					<div class="input-container">
